...
function processCommits(data) {
  return d3
    ...
    .map(([commit, lines]) => {
      ...
      // Store lines as non-enumerable property but still accessible for JSON serialization
      Object.defineProperty(ret, 'lines', {
        value: lines,       // Set the value of 'lines'
        enumerable: true,   // Keep enumerable for JSON serialization
        writable: false,    // Prevent accidental modification
        configurable: false // Prevent deletion or reconfiguration
      });
      
      // Add longestLine calculation to match main.js
